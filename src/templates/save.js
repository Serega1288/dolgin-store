...
import GetSaveProduct from "../components/global/getSaveProduct";
                    ...
                    { typeof window !== 'undefined' &&
                            ...
                            localStorage.getItem('array-active-save').length !== 2 ? (
                                ...
                                <div className="col-12">
                                    <GetInfoResult info="save" title="Страница пустая" text="Пока нет сохраненых товаров" classBox='h-100 ' homeBtn={true} />
                                </div>
                            )
